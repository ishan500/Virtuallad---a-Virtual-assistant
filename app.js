...
function speakThis(message) {
    ...
    if (message.includes('hi') || message.includes('hello') || message.includes('hii') || message.includes('hey')) {
        ...
        const finalText = 'I am fine ishan tell me how can i help you';
        speech.text = finalText;
    }
        ...
        const finalText = 'you fuck off and go to hell  dont talk to me and abuse me ';
        speech.text = finalText;
    }
        ...
        window.open('Macintosh HD⁩ ▸ ⁨Applications⁩');
